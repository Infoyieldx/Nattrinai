...
export const categories = [
  ...
  { id: 4, name: 'Pickles / Thokku', image: Pickles },
...
export const subcategories = {
  ...
  'Health Drinks': [
    {
      id: 1, name: 'Energy Boosters', products: [
        {
          id: 20001,
